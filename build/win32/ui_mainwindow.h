...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(90, 40, 671, 401));
        ...
        gridLayoutWidget->setGeometry(QRect(70, 90, 241, 219));
        ...
        gridLayout->addWidget(pushButton_del, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(pushButton_add, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_add, 7, 2, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_get, 4, 2, 1, 1);
